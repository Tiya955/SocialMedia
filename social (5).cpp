...
int main() {
    ...
    while (true) {
        if (!socialMedia.isLoggedIn()) {
            ...
            cout << "|  9. View Someone's Profile                      |" << endl;
            cout << "| 10. Post to Someone's Wall                      |" << endl;
            cout << "+--------------------------------------------------+" << endl;
            cout << "|  0. Logout                                      |" << endl;
            cout << "+--------------------------------------------------+" << endl;
            cout << "Choice: ";
            ...
            switch(choice) {
                ...
                case 5: {
                    ...
                    if (friendUser && friendUser->getId() != current->getId()) {
                        socialMedia.addFriendship(current->getId(), friendUser->getId());
                        cout << "[SUCCESS] You are now friends with " << friendName << "!" << endl;
                    } else {
                        cout << "[ERROR] User not found or can't add yourself!" << endl;
                    }
                    break;
                }
